...
From the numerical simulation point of view, research problems in plasmas in tokamaks are very challenging due to complex and high nonlinear dynamics described by differential equations. % coupled with the high numbers and dimensions of parameters and variables to consider. 
